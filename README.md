1. Nombre del proyecto
   MenuReview
3. Integrantes
   Rodrigo Gomonal Contardo
5. Funcionalidades
   1. Geolocalizacion de restaurante.
   2. Registro y Login de usuarios.
   3. Dejar reseña y valoracion a un restaurante.
   4. Editar Perfil.
   5. Ver perfiles de restaurantes.
   6. Ver Valoraciones y reseñas de resturantes.
